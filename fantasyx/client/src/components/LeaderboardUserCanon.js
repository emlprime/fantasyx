...
class LeaderboardUserCanon extends Component {
    componentWillMount() {
        setTimeout(() => {this.getScores()}, 100);
    }

    getScores() {
        const msg = JSON.stringify({type: 'scores', options: {pivot: 'user', canon: 'canon'}})
...
const LeaderboardUserCanonContainer = connect(  
    mapStateToProps,
